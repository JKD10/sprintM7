...
function validarNombres() {
    ...
    if (nombresValue.length < 4 || nombresValue.length > 30) {
        mostrarMensajeValidacion(nombresInput, 'El nombre debe tener entre 4 y 30 caracteres.');
        return false;
    } else {
...
function validarApellidos() {
    ...
    if (apellidosValue.length < 4 || apellidosValue.length > 30) {
        mostrarMensajeValidacion(apellidosInput, 'El apellido debe tener entre 4 y 30 caracteres.');
        return false;
    } else {
...
function validarComuna() {
    ...
    if (comunaValue.length < 4 || comunaValue.length > 60) {
        mostrarMensajeValidacion(comunaInput, 'La comuna debe tener entre 4 y 60 caracteres.');
        return false;
    } else {
...
function validarCalle() {
    ...
    if (calleValue.length < 4 || calleValue.length > 60) {
        mostrarMensajeValidacion(calleInput, 'La calle debe tener entre 4 y 60 caracteres.');
        return false;
    } else {
