...
function validarNombres() {
    return validarCampo(nombresInput, 4, 30, 'El nombre debe tener entre 4 y 30 caracteres.');
}
...
function validarApellidos() {
    return validarCampo(apellidosInput, 4, 30, 'El apellido debe tener entre 4 y 30 caracteres.');
}
