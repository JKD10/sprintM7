...
<body>
	...
	<div class="contacto" style="display: flex; justify-content: center;">
		...
		<form id="formularioRegistroCliente" action="/jkdtechnology/registroCliente"
			...
			<div style="display: flex; justify-content: center;" class="mb-5">
				<input type="submit" value="Registrar" class="boton-enviar" style="margin-right: 10px; border: 5px; padding: 7px 15px;">
				<a href="registroUsuario" class="btn btn-primary" style="border: 5px; padding: 7px 15px;">Volver atrás</a>
			</div>
		</form>
	</div>
	...
	<script src="/jkdtechnology/res/js/validacionesRegistroCliente.js"></script>
