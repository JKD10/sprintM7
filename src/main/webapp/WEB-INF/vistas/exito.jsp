...
<body>
	...
	<div class="exito-container">
		...
		<div style="text-align: center;">
			<img src="/jkdtechnology/res/img/robot_exito.jpg"
				alt="Imagen de éxito">
		</div>
		<p>Redireccionando...</p>
	</div>
	...
	<script>
		// Redireccionar automáticamente a /jkdtechnology/ después de 5 segundos (5000 milisegundos)
		setTimeout(function() {
			window.location.href = "/jkdtechnology/";
		}, 5000);
	</script>
</body>
</html>
