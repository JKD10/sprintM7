...
<body>
	...
	<div class="centered-content">
		...
		<nav
			class="navbar navbar-expand-sm navbar-expand-lg navbar-expand-md navbar-dark bg-black">
			<div class="container-fluid d-flex text-center">
				<!-- Contenedor para el logo -->
				<div class="navbar-brand-container">
					<div class="col-md-12 col-lg-12 col-sm-12 col-xs-6">
						<a class="navbar-brand" href="#"> <img
							src="/jkdtechnology/res/img/logo-jkdtechnology.png" alt="logo de la empresa" class="img-fluid">
						</a>
					</div>
					...
					<div
						...
						<ul class="navbar-nav">
							...
							<li class="nav-item"><a class="nav-link" href="/jkdtechnology/"
