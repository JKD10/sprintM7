...
<body>
		...
		<div class="contacto" style="display: flex; justify-content: center;">
			...
			<form id="formularioCrearPedido"
				...
				<div class="form-group mt-5"
					style="margin-left: auto; margin-right: auto; display: table;">
					<label for="indicaciones">Indicaciones ("Entregar en recepcion",
						"Dejar en Puerta", "Llamar antes de llegar", etc.):</label><br>
	...
	<script src="/jkdtechnology/res/js/calculoPrecioTotal.js"></script>
	<script
